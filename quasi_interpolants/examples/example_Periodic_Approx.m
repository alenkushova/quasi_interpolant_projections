...
drch_dir     = [];   % Dirchlet boundaries
prdc_dir     = [1 2];   % Periodic boundaries
...
%% Proiezione con dati al bordo periodici è ok!
[Lam1, Lam2] = Lyche_c_2D_Periodic (ux, uy, space);
Lam  = cat(1,Lam1,Lam2);
Phi          = Lyche_2D_Periodic (u, space_v);
