% MY_OP_DIV_V_Q: assemble the matrix B = [b(i,j)], b(i,j) = (epsilon q_i, div v_j).
%
%   mat = op_div_v_q (spv, spq, msh, [epsilon]);
%   [rows, cols, values] = op_div_v_q (spv, spq, msh, [epsilon]);
%
% INPUT: 
%
...
function varargout = my_op_div_v_q (spv, spq, msh, coeff)
