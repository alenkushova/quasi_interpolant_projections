...
filename     = '2D_periodic_u0_128x128_degree_6x6_eig4_constant_c.mat'; % c=2;
...
method_data.k            = 1/8;   % Time step così varia solo lui.
...
filename = ['test_c_cost_' num2str(n) 'x' num2str(n) 'x' num2str(1/k) '.mat'];
save(filename)
