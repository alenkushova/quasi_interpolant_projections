...
filename     = '2D_mixed_u0_128x128_degree_6x6_eig4_sine_c_iso.mat'; % c=2;
...
problem_data.periodic_sides = [2];     % Periodic
...
method_data.k            = 1/30000; % Time step così varia solo lui.
...
%% 4) POST-PROCESSING: Numerical solution
N = 60;
...
%% 5) error with overkill solution 
tic
err_p = []; err_v = [];
