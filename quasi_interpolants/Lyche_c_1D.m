function Lam = Lyche_c_1D(f, space)
...
for i = 1 : (s-1)/2 % il primo so già che fa zero. 
    int1 = int1 + h1/3*(F(2*i-1) +4*F(2*i)+F(2*i+1)); % C-S quadrature rule 
    F1(i+1) = int1;
end
