% MY_OP_DIV_V_Q_TP: assemble the matrix B = [b(i,j)], b(i,j) = (epsilon q_i, div v_j), exploiting the tensor product structure.
%
%   mat = op_div_v_q_tp (spv, spq, msh, [epsilon]);
%   [rows, cols, values] = op_div_v_q_tp (spv, spq, msh, [epsilon]);
%
% INPUT: 
%
...
function varargout = my_op_div_v_q_tp (spv, spq, msh, coeff)
  ...
  for iel = 1:msh.nel_dir(1)
    ...
    A = A + my_op_div_v_q (spv_col, spq_col, msh_col, coeffs);
  end
