...
filename     = '2D_dirichlet_u0_128x128_degree_6x6_eig4_constant_c.mat'; % c=2;
...
tic
    [geometry, msh, space_p, L, space_v, P] = ...
                      solve_wave_dirichlet_QI_2D (problem_data, method_data);
toc
...
filename = ['test_c_cost_' num2str(n) 'x' num2str(n) 'x' num2str(1/k) 'drchlt.mat'];
save(filename)
